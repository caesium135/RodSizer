...
echo     from stardist.models import StarDist2D >> "%TEMP_CHECK%"
echo     print('  - StarDist: OK') >> "%TEMP_CHECK%"
echo     from csbdeep.utils import normalize >> "%TEMP_CHECK%"
echo     print('  - csbdeep: OK') >> "%TEMP_CHECK%"
